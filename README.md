...
Streamlit-приложение на Python для визуализации данных о диабете из [Apple Health (HealthKit)](https://www.apple.com/health/).
...
- 📦 Парсинг Apple Health export потоково через `iterparse`
- 🩸 Извлекаемые метрики:
...
- 📈 Сводная статистика за выбранный период:
  - глюкоза: **среднее / мин / макс**
  - время в диапазонах: **TIR / TAR / TBR**
  - суммарный инсулин (**базал + болюс**) и углеводы
